[discrete]
[[daisy-chain-n]]
== image::yes.png[yes] daisy chain (noun)
...
[discrete]
[[daisy-chain-v]]
== image::yes.png[yes] daisy chain (verb)
...
[discrete]
[[data-center]]
== image::yes.png[yes] data center (noun)
...
[discrete]
[[data-enumeration]]
== image::yes.png[yes] data enumeration (noun)
...
[discrete]
[[data-grid]]
== image::yes.png[yes] Data Grid (noun)
...
[discrete]
[[data-grid-console]]
== image::yes.png[yes] Data Grid Console (noun)
...
[discrete]
[[data-grid-server]]
== image::yes.png[yes] Data Grid Server (noun)
...
[discrete]
[[data-mirroring]]
== image::yes.png[yes] data mirroring (noun)
...
[discrete]
[[data-model]]
== image::yes.png[yes] data model (noun)
...
[discrete]
[[data-modeler]]
== image::yes.png[yes] Data Modeler (noun)
...
[discrete]
[[data-path-n]]
== image::yes.png[yes] data path (noun)
...
[discrete]
[[data-warehouse]]
== image::yes.png[yes] Data Warehouse (noun)
...
[discrete]
[[datasource]]
== image::yes.png[yes] datasource subsystem (noun)
...
[discrete]
[[debug-adj]]
== image::yes.png[yes] debug (adjective)
...
[discrete]
[[decision-table]]
== image::yes.png[yes] decision table (noun)
...
[discrete]
[[decision-tree]]
== image::yes.png[yes] decision tree (noun)
...
[discrete]
[[delivery]]
== image::yes.png[yes] delivery (noun)
...
[discrete]
[[denial-of-service-n]]
== image::yes.png[yes] denial of service (noun)
...
== image::yes.png[yes] denial-of-service (adjective)
...
[discrete]
[[deployment]]
== image::yes.png[yes] deployment (noun)
...
[discrete]
[[deployment-scanner]]
== image::yes.png[yes] deployment-scanner subsystem (noun)
...
[discrete]
[[desktop-adj]]
== image::yes.png[yes] desktop (adjective)
...
[discrete]
[[desktop-n]]
== image::yes.png[yes] desktop (noun)
...
[discrete]
[[destination]]
== image::caution.png[with caution] destination (noun)
...
[discrete]
[[details-view]]
== image::yes.png[yes] details view (noun)
...
[discrete]
[[developer-preview]]
== image::yes.png[yes] Developer Preview (noun)
...
[discrete]
[[different]]
== image::yes.png[yes] different from (preposition)
...
[discrete]
[[direct-grant]]
== image::yes.png[yes] direct grant
...
== image::yes.png[yes] direct routed messaging (noun)
...
[discrete]
[[director]]
== image::yes.png[yes] director (noun)
...
[discrete]
[[directory-manager]]
== image::yes.png[yes] Directory Manager (noun)
...
[discrete]
[[directory-server]]
== image::yes.png[yes] directory server (noun)
...
[discrete]
[[disconnected]]
== image::yes.png[yes] disconnected (adjective)
...
[discrete]
[[disk-druid]]
== image::yes.png[yes] Disk Druid (noun)
...
[discrete]
[[disk-label]]
== image::yes.png[yes] disk label (noun)
...
[discrete]
[[dispatch-router]]
== image::caution.png[with caution] Dispatch Router (noun)
...
[discrete]
[[distinguished-name]]
== image::yes.png[yes] distinguished name (noun)
...
[discrete]
[[dns-ptr-records]]
== image::yes.png[yes] DNS PTR records (noun)
...
[discrete]
[[dns-srv-records]]
== image::yes.png[yes] DNS SRV records (noun)
...
[discrete]
[[dockerfile]]
== image::yes.png[yes] Dockerfile (noun)
...
[discrete]
[[domain-controller]]
== image::yes.png[yes] domain controller (noun)
...
[discrete]
[[domain-mode]]
== image::no.png[no] domain mode (noun)
...
[discrete]
[[domain-name]]
== image::yes.png[yes] domain name (noun)
...
[discrete]
[[download-n]]
== image::yes.png[yes] download (noun)
...
[discrete]
[[download-v]]
== image::yes.png[yes] download (verb)
...
[discrete]
[[downstream-adj]]
== image::yes.png[yes] downstream (adjective)
...
[discrete]
[[downstream-n]]
== image::yes.png[yes] downstream (noun)
...
[discrete]
[[drools-expert]]
== image::yes.png[yes] Drools Expert (noun)
...
[discrete]
[[dual-boot]]
== image::yes.png[yes] dual-boot (adjective)
...
[discrete]
[[DVD-writer]]
== image::yes.png[yes] DVD writer (noun)

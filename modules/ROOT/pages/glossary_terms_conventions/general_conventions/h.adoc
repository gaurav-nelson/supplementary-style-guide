[discrete]
[[hard-code]]
== image::yes.png[yes] hard code (verb)
...
[discrete]
[[hard-coded]]
== image::yes.png[yes] hard-coded (adjective)
...
[discrete]
[[header-bar]]
== image::yes.png[yes] header bar (noun)
...
[discrete]
[[health-check]]
== image::yes.png[yes] health check (noun)
...
[discrete]
[[help-desk]]
== image::yes.png[yes] help desk (noun)
...
[discrete]
[[hidden-replica]]
== image::yes.png[yes] hidden replica (noun)
...
== image::yes.png[yes] high availability (noun)
...
[discrete]
[[high-availability]]
== image::yes.png[yes] high-availability (adjective)
...
== image::yes.png[yes] high-performance computing (noun)
...
== image::yes.png[yes] horizontal pod autoscaler (noun)
...
[discrete]
[[host-group]]
== image::yes.png[yes] host group (noun)
...
[discrete]
[[host-system]]
== image::yes.png[yes] host system (noun)
...
[discrete]
[[hot-add]]
== image::yes.png[yes] hot add (verb)
...
[discrete]
[[hot-plug]]
== image::yes.png[yes] hot plug (verb)
...
[discrete]
[[hot-rod]]
== image::yes.png[yes] Hot Rod (adjective)
...
[discrete]
[[hot-swap]]
== image::yes.png[yes] hot swap (verb)
...
[discrete]
[[hotline]]
== image::yes.png[yes] hotline (noun)
...
[discrete]
[[hp-proliant]]
== image::yes.png[yes] HP ProLiant (noun)
...
[discrete]
[[http-interface]]
== image::no.png[no] HTTP interface (noun)
...
[discrete]
[[huge-page-noun]]
== image::yes.png[yes] huge page (noun)
...
[discrete]
[[huge-page]]
== image::yes.png[yes] huge-page (adjective)
...
[discrete]
[[hyper-threading]]
== image::yes.png[yes] Hyper-Threading (noun)
...
[discrete]
[[hyperv]]
== image::yes.png[yes] Hyper-V (noun)
...
[discrete]
[[hyperconverged]]
== image::yes.png[yes] hyperconverged (adjective)
...
[discrete]
[[hypervisor]]
== image::yes.png[yes] hypervisor (noun)

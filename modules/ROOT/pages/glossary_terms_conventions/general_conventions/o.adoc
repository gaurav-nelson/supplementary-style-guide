[discrete]
[[o-ran]]
== image::caution.png[with caution] O-RAN (noun)
...
[discrete]
[[object-bucket]]
== image::yes.png[yes] object bucket (noun)
...
[discrete]
[[object-bucket-claim]]
== image::yes.png[yes] object bucket claim (noun)
...
[discrete]
[[object-class]]
== image::yes.png[yes] object class (noun)
...
== image::yes.png[yes] Object Storage Device (noun)
...
[discrete]
[[object-store]]
== image::yes.png[yes] Object Store (noun)
...
[discrete]
[[objectclass]]
== image::yes.png[yes] objectClass (noun)
...
[discrete]
[[objective-c]]
== image::yes.png[yes] Objective C (noun)
...
[discrete]
[[offline-backup]]
== image::yes.png[yes] offline backup (noun)
...
[discrete]
[[on-board]]
== image::caution.png[with caution] on-board (adjective)
...
[discrete]
[[on-premise]]
== image::caution.png[with caution] on-premise (adjective)
...
[discrete]
[[onboard]]
== image::caution.png[with caution] onboard (verb)
...
[discrete]
[[online-backup]]
== image::yes.png[yes] online backup (noun)
...
[discrete]
[[open-architecture]]
== image::yes.png[yes] open architecture (noun)
...
[discrete]
[[open-ran]]
== image::caution.png[with caution] Open RAN (noun)
...
[discrete]
[[open-source]]
== image::yes.png[yes] open source (noun)
...
[discrete]
[[openran]]
== image::caution.png[with caution] OpenRAN (noun)
...
[discrete]
[[openshift]]
== image::caution.png[with caution] OpenShift (noun)
...
[discrete]
[[openshift-cli]]
== image::yes.png[yes] OpenShift CLI (noun)
...
== image::yes.png[yes] OpenShift Container Registry (noun)
...
[discrete]
[[openshift-master]]
== image::yes.png[yes] OpenShift master (noun)
...
[discrete]
[[openshift-origin]]
== image::no.png[no] OpenShift Origin (noun)
...
[discrete]
[[openwire]]
== image::yes.png[yes] OpenWire (noun)
...
== image::yes.png[yes] operating environment (noun)
...
[discrete]
[[operating-system]]
== image::yes.png[yes] operating system (noun)
...
[discrete]
[[operator]]
== image::yes.png[yes] Operator (noun)
...
[discrete]
[[operator-framework]]
== image::yes.png[yes] Operator Framework (noun)
...
== image::yes.png[yes] Operator Lifecycle Manager (noun)
...
[discrete]
[[operator-hub]]
== image::yes.png[yes] OperatorHub (noun)
...
== image::yes.png[yes] Organization Administrator (noun)
...
[discrete]
[[organizational-unit]]
== image::yes.png[yes] organizational unit (noun)
...
[discrete]
[[osd-daemon]]
== image::yes.png[yes] OSD Daemon (noun)
...
[discrete]
[[output-device]]
== image::yes.png[yes] output device (noun)
...
[discrete]
[[overcloud]]
== image::yes.png[yes] overcloud (noun)
...
[discrete]
[[override]]
== image::yes.png[yes] override (verb)

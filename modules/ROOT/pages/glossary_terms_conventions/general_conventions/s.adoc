[discrete]
[[s-record]]
== image::yes.png[yes] S-record (noun)
...
[discrete]
[[sar]]
== image::yes.png[yes] sar subsystem (noun)
...
[discrete]
[[satellite-server]]
== image::yes.png[yes] Satellite Server (noun)
...
[discrete]
[[scheduler]]
== image::yes.png[yes] scheduler (noun)
...
[discrete]
[[scorecard]]
== image::yes.png[yes] Scorecard (noun)
...
[discrete]
[[screen-saver]]
== image::yes.png[yes] screen saver (noun)
...
[discrete]
[[scrollbar]]
== image::yes.png[yes] scrollbar (noun)
...
[discrete]
[[scrubbing]]
== image::yes.png[yes] scrubbing (noun)
...
[discrete]
[[security-elytron]]
== image::yes.png[yes] Security - Elytron (noun)
...
[discrete]
[[security]]
== image::yes.png[yes] security subsystem (noun)
...
[discrete]
[[security-manager]]
== image::yes.png[yes] security-manager subsystem (noun)
...
[discrete]
[[segmentation-fault]]
== image::yes.png[yes] segmentation fault (noun)
...
[discrete]
[[self-hosted-engine]]
== image::yes.png[yes] self-hosted engine (noun)
...
== image::yes.png[yes] self-hosted engine node (noun)
...
[discrete]
[[selinux]]
== image::yes.png[yes] SELinux (noun)
...
[discrete]
[[server-cluster]]
== image::yes.png[yes] server cluster (noun)
...
[discrete]
[[server-farm]]
== image::yes.png[yes] server farm (noun)
...
[discrete]
[[service]]
== image::yes.png[yes] service (noun)
...
[discrete]
[[service-account]]
== image::yes.png[yes] service account (noun)
...
[discrete]
[[session]]
== image::caution.png[with caution] session (noun)
...
== image::yes.png[yes] session externalization (noun)
...
[discrete]
[[session-persistence]]
== image::yes.png[yes] session persistence (noun)
...
[discrete]
[[shadow-passwords]]
== image::yes.png[yes] shadow passwords (noun)
...
[discrete]
[[shadow-utilities]]
== image::yes.png[yes] shadow utilities (noun)
...
[discrete]
[[shadowman]]
== image::yes.png[yes] Shadowman (noun)
...
[discrete]
[[sharded-queue]]
== image::yes.png[yes] sharded queue (noun)
...
[discrete]
[[share-name]]
== image::yes.png[yes] share name (noun)
...
[discrete]
[[shell-prompt]]
== image::yes.png[yes] shell prompt (noun)
...
[discrete]
[[signal-topology]]
== image::yes.png[yes] signal topology (noun)
...
[discrete]
[[singleton]]
== image::yes.png[yes] singleton subsystem (noun)
...
[discrete]
[[skill-set]]
== image::no.png[no] skill set (noun)
...
[discrete]
[[slave-broker]]
== image::yes.png[yes] slave broker (noun)
...
[discrete]
[[smart-card]]
== image::yes.png[yes] smart card (noun)
...
[discrete]
[[smartstate-analysis]]
== image::yes.png[yes] SmartState analysis (noun)
...
[discrete]
[[snapshot-set]]
== image::yes.png[yes] snapshot set (noun)
...
[discrete]
[[software-collection]]
== image::yes.png[yes] Software Collection (noun)
...
[discrete]
[[sound-card]]
== image::yes.png[yes] sound card (noun)
...
[discrete]
[[source-navigator]]
== image::yes.png[yes] Source-Navigator^TM^ (noun)
...
[discrete]
[[source-to-image]]
== image::yes.png[yes] Source-to-Image (S2I) (noun)
...
[discrete]
[[spacebar]]
== image::yes.png[yes] spacebar (noun)
...
[discrete]
[[sparse]]
== image::yes.png[yes] sparse (adjective)
...
[discrete]
[[sparsify]]
== image::yes.png[yes] sparsify (verb)
...
[discrete]
[[spec-file]]
== image::yes.png[yes] spec file (noun)
...
[discrete]
[[specific]]
== image::yes.png[yes] specific (noun)
...
[discrete]
[[spelled]]
== image::yes.png[yes] spelled (verb)
...
[discrete]
[[ssl-tls]]
== image::yes.png[yes] SSL/TLS (noun)
...
[discrete]
[[sssd-back-end]]
== image::yes.png[yes] SSSD back end (noun)
...
[discrete]
[[standalone]]
== image::yes.png[yes] standalone (adjective)
...
[discrete]
[[standalone-manager]]
== image::yes.png[yes] standalone Manager (noun)
...
[discrete]
[[standalone-mode]]
== image::no.png[no] standalone mode (noun)
...
[discrete]
[[standalone-server]]
== image::yes.png[yes] standalone server (noun)
...
[discrete]
[[staroffice]]
== image::yes.png[yes] StarOffice (noun)
...
[discrete]
[[starttls]]
== image::yes.png[yes] STARTTLS (noun)
...
[discrete]
[[static-delta]]
== image::yes.png[yes] static-delta (noun)
...
[discrete]
[[sticky-bit]]
== image::yes.png[yes] sticky bit (noun)
...
[discrete]
[[sticky-session]]
== image::yes.png[yes] sticky session (noun)
...
[discrete]
[[storage-class]]
== image::yes.png[yes] storage class (noun)
...
== image::yes.png[yes] Storage Pool Manager (noun)
...
[discrete]
[[straightforward]]
== image::yes.png[yes] straightforward (adjective)
...
[discrete]
[[sub-version]]
== image::yes.png[yes] sub-version (noun)
...
[discrete]
[[subcommand]]
== image::yes.png[yes] subcommand (noun)
...
[discrete]
[[subdirectory]]
== image::yes.png[yes] subdirectory (noun)
...
[discrete]
[[submenu]]
== image::yes.png[yes] submenu (noun)
...
[discrete]
[[subpackage]]
== image::yes.png[yes] subpackage (noun)
...
[discrete]
[[subscription]]
== image::yes.png[yes] subscription (noun)
...
== image::yes.png[yes] Subscription Manifest (noun)
...
[discrete]
[[sudo]]
== image::caution.png[with caution] sudo (noun)
...
[discrete]
[[superuser]]
== image::yes.png[yes] superuser (noun)
...
[discrete]
[[supplier]]
== image::yes.png[yes] supplier (noun)
...
[discrete]
[[swap-space]]
== image::yes.png[yes] swap space (noun)
...
== image::yes.png[yes] Sybase Adaptive Server Enterprise (noun)
...
== image::yes.png[yes] symmetric encryption (noun)
...
[discrete]
[[syndesis]]
== image::yes.png[yes] Syndesis (noun)
...
[discrete]
[[sysprep]]
== image::yes.png[yes] sysprep (noun)
...
[discrete]
[[systemd]]
== image::yes.png[yes] systemd (noun)

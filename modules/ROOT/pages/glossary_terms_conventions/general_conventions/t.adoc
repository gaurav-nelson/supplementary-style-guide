...
[discrete]
[[target-kernel]]
== image::yes.png[yes] target kernel (noun)
...
[discrete]
[[target-system]]
== image::yes.png[yes] target system (noun)
...
[discrete]
[[technology-preview]]
== image::yes.png[yes] Technology Preview (noun)
...
[discrete]
[[template]]
== image::yes.png[yes] template (noun)
...
[discrete]
[[terminal-emulation]]
== image::yes.png[yes] terminal emulation (noun)
...
[discrete]
[[text-mode]]
== image::yes.png[yes] text mode (noun)
...
[discrete]
[[text-based]]
== image::yes.png[yes] text-based (adjective)
...
[discrete]
[[thin-provisioned]]
== image::yes.png[yes] thin-provisioned (adjective)
...
[discrete]
[[throughput]]
== image::yes.png[yes] throughput (noun)
...
== image::yes.png[yes] ticket-granting ticket (noun)
...
[discrete]
[[tier-1]]
== image::yes.png[yes] tier-1 (adjective)
...
[discrete]
[[time-frame]]
== image::yes.png[yes] time frame (noun)
...
[discrete]
[[time-to-live-n]]
== image::yes.png[yes] time to live (noun)
...
[discrete]
[[time-to-live-adj]]
== image::yes.png[yes] time-to-live (adjective)
*Description*: Do not capitalize "time-to-live" unless you are documenting a GUI field, label, or similar element, in which case you should use the same capitalization. Capitalization at the beginning of a sentence is acceptable.
...
[discrete]
[[tls-handshake]]
== image::yes.png[yes] TLS handshake (noun)
...
[discrete]
[[totally]]
== image::no.png[no] totally (adverb)
...
[discrete]
[[transactions]]
== image::yes.png[yes] transactions subsystem (noun)
...
== image::yes.png[yes] trusted certificate authority (noun)
...
[discrete]
[[truststore]]
== image::yes.png[yes] truststore (noun)
...
== image::yes.png[yes] truth maintenance system (noun)

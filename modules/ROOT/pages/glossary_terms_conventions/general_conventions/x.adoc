[discrete]
[[x]]
== image::caution.png[with caution] X (noun)
...
[discrete]
[[xen]]
== image::caution.png[with caution] Xen (adjective)
...
[discrete]
[[xts]]
== image::yes.png[yes] xts subsystem (noun)
